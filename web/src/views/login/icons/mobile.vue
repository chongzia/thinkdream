<template>
  <svg xmlns="http://www.w3.org/2000/svg" class="w-8 text-slate-400 hover:text-indigo-600 cursor-pointer" width="24" height="24" viewBox="0 0 24 24">
    <path
      fill="currentColor"
    ...
    />
    <path fill="currentColor" d="M10 18.934h4a.5.5 0 0 0 0-1h-4a.5.5 0 0 0 0 1Z" />
  </svg>
</template>
