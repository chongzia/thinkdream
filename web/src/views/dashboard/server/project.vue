  ...
  <div class="w-full">
    <el-card shadow="never">
      ...
      <div class="grid grid-cols-1 gap-1 sm:grid-cols-1">
        ...
        <div class="grid grid-cols-1 gap-1 mt-2 sm:grid-cols-3">
          <el-card shadow="hover">
            <div class="text-center">易用</div>
            <div class="pt-2 text-sm text-gray-400">catchadmin 是从头开始设计的模块化框架，解耦化的设计让你轻松驾驭框架</div>
          </el-card>
          <el-card shadow="hover">
            <div class="text-center">专注</div>
            <div class="pt-2 text-sm text-gray-400">catchadmin 加入大量快速开发组件，让你专注于后台管理的开发，而无需重复无意义的工作</div>
          </el-card>
          <el-card shadow="hover">
            <div class="text-center">强大</div>
            <div class="pt-2 text-sm text-gray-400">catchadmin 基于 PHP 庞大的生态，使其稳定并且强大。使用 catchadmin 可以开发任意 web 应用</div>
          </el-card>
        </div>
      </div>
    </el-card>
