<template>
  <el-form ref="formRef" :model="formData" :rules="rules" label-position="top">
    ...
    <el-form-item label="关联方法名" prop="relation">
      <el-input v-model="formData.relation" placeholder="例如: posts" />
...
// 使用模型关系 hook
const { modules, availableFields, relatedModelFields, handleRelatedModelChange, getPluralRelationName, loadCurrentModelFields } = useModelRelation()

const model = defineModel<HasManyParams>({
  default: () => ({
    relatedModel: '',
    foreignKey: '',
    localKey: '',
...
const formData = reactive<HasManyParams>({
...
// Laravel hasMany validation rules
