<template>
  <el-form ref="formRef" :model="formData" :rules="rules" label-position="top">
    ...
    <el-form-item label="关联方法名" prop="relation">
      <el-input v-model="formData.relation" placeholder="例如: profile" clearable />
...
const model = defineModel<HasOneThroughParams>({
  default: () => ({
    targetModel: '',
    throughModel: '',
    firstKey: '',
...
const formData = reactive<HasOneThroughParams>({
...
const relationName = computed(() => {
  if (!formData.relation) {
    ...
    return getSingularRelationName(formData.targetModel)
  }
...
// Laravel hasOneThrough validation rules
