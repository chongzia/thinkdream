        ...
        <div class="flex flex-col w-2/3 mx-auto">
          <el-form-item label="分类类型" prop="site_category_types">
            <div class="flex flex-col w-full gap-y-2">
              <div class="flex flex-row gap-x-2" v-for="(item, k) in formData.site_category_types" :key="k">
          ...
          <el-form-item label="简洁模式">
            <el-radio-group v-model="formData.is_simple_url">
              <el-radio-button :value="1" size="small">是</el-radio-button>
              <el-radio-button :value="2" size="small">否</el-radio-button>
            </el-radio-group>
          ...
          <el-form-item label="链接结构">
            <el-radio-group v-model="formData.site_url_struct" class="flex flex-col justify-center">
              <div class="w-full">
                <el-radio :value="1">动态模式<span class="ml-3 text-sm text-gray-400">https://domain.com/post?id=1</span> </el-radio>
              </div>
              <div class="w-full">
                <el-radio :value="2">静态模式<span class="ml-3 text-sm text-gray-400">https://domain.com/post/{id}</span> </el-radio>
              </div>
              <div class="w-full">
                <el-radio :value="3"
