<template>
  <el-form :model="formData" label-width="120px" ref="form" v-loading="loading" class="pr-4">
    ...
    >
      <el-input v-model="formData.key" name="key" clearable show-word-limit maxlength="50" />
    </el-form-item>
    <el-form-item label="字典描述" prop="description">
      <el-input v-model="formData.description" name="description" clearable type="textarea" show-word-limit maxlength="100" />
    </el-form-item>
