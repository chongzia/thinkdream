<template>
  <div class="flex flex-col sm:flex-row w-full">
    <el-card shadow="never" class="w-full sm:w-[35rem] h-[32rem] bg-white dark:bg-regal-dark">
      <template #header>
    ...
    <el-tabs v-model="activeName" class="pl-3 pr-3 bg-white dark:bg-regal-dark w-full ml-0 sm:ml-3">
