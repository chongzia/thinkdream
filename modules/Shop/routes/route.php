...
use Modules\Shop\Http\Controllers\ConfigController;
use Modules\Shop\Http\Controllers\CouponController;
use Modules\Shop\Http\Controllers\DiyTemplatesController;
use Modules\Shop\Http\Controllers\PointController;
use Modules\Shop\Http\Controllers\ProductBrandController;
use Modules\Shop\Http\Controllers\ProductController;
use Modules\Shop\Http\Controllers\ProductServicesController;
use Modules\Shop\Http\Controllers\ProductSpecTmpController;
use Modules\Shop\Http\Controllers\ProductTagsController;
use Modules\Shop\Http\Controllers\SeckillActivityController;
use Modules\Shop\Http\Controllers\SeckillProductsController;
use Modules\Shop\Http\Controllers\ShipTemplateController;
use Modules\Shop\Http\Controllers\VipRechargePlansController;
