...
use Modules\Shop\Models\ProductInfo;
use Modules\Shop\Models\Products;
use Modules\Shop\Models\ProductSku;
use Modules\Shop\Models\ProductSpec;
use Modules\Shop\Models\ProductSpecValues;
use Throwable;
                ...
                foreach ($specs as $spec) {
                    ...
                    if (! $specId) {
                        ...
                        if ($originSpecName != $spec['name']) {
                            $this->productSpecModel->where('id', $specId)->update(['name' => $spec['name']]);
                        }
                    }
